              ...
              <ContentContainer>
                <div className="w-full px-5 md:px-0 py-5 md:py-25 flex items-center justify-center">
                  <div className="w-full md:w-[80%] lg:w-[60%]">
                    ...
                    <p className="mt-5 md:mt-10 text-black text-[.8rem] md:text-[1rem] font-light text-justify leading-6 md:leading-8 capitalize">
                      GAGASAN MENCIPTAKAN LAYANAN WISATA PREMIUM YANG KOMPREHENSIV DAN BERTEMA, DI ZONA WISATA YOGYAKARTA, MAGELANG  & SURAKATA (SOLO). KALA KELANA LAHIR DARI MANAJEMEN BERLATAR BELAKANG MULTI BIDANG LEBIH DARI 28 TAHUN DIDUNIA BISNIS, INVESTASI, PERHOTELAN, PARIWISATA, TRAVEL, EVENTS & TEKNOLOGI.  HADIR SEBAGAI ICON BARU DAN TREND-SETTER WISATA DI INDONESIA MENJADI PERJUANGAN IDEALISME MANAJEMEN UNTUK PERSEMBAHAN PENIKMAT WISATA & MICE DENGAN PENGALAMAN BARU. HIDUP ADALAH TENTANG PERJALANAN BERKELANA UNTUK MENOREHKAN CERITA INDAH, KALA KELANA, KETIKA PERJALANAN HIDUP YANG ISTIMEWA KAMI HADIRKAN UNTUK KITA BINGKAI JADI BAGIAN CERITA KELANA HIDUP ANDA KELAK.</p>

                    <div className="flex flex-col mt-10 gap-2">
                      <span>Yogyakarta, 6 Desember  2025</span>
                      <span>SALAM KALA KElANA;</span>
